...
## ------------------------------------------------------------------------
boxplot(airline.df$FractionPremiumSeats, data=airline.df, main="Fraction of Premium Economy Seats", 
  	xlab="Fraction of Premium Economy Seats in Plane", ylab="", horizontal=TRUE )

## ------------------------------------------------------------------------
xyplot(PriceRelative ~ FractionPremiumSeats, data = airline.df
       ,type = c("p", "g", "smooth"),
       xlab = "Fraction of Premium Economy Seats in Plane", ylab = "Rel. Price Difference"
       )
...
scatterplotMatrix(~PricePremium+PriceEconomy+SeatsTotal+FractionPremiumSeats, data=airline.df,
  	main="Premium Economy vs. Economy Airfares")
...
colairlines2 <- c("PricePremium","PriceEconomy","SeatsTotal","FractionPremiumSeats")
...
library(car)
library(corrgram)
colairlines <- c("PricePremium","PriceEconomy","PitchDifference","WidthDifference","SeatsTotal","FractionPremiumSeats")
